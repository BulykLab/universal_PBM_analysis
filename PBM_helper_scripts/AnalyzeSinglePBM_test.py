...
BEEML_path = '/data/bulyk/pipelines/universal_PBM_analysis/BEEML_PBM_Example/'
...
if not isfile(primary_pwm_file) or args.override is True:
    call(primary_SNW_call, shell = True)
...
if not isfile(secondary_pwm_file) or args.override is True:
    call(secondary_SNW_call, shell = True)
...
#no more running_jobs; everything run in this job
